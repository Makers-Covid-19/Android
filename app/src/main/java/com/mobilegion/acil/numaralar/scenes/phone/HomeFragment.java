...
import com.mobilegion.acil.numaralar.api.model.districts.DistrictModel;
import com.mobilegion.acil.numaralar.api.model.districts.DistrictRequest;
import com.mobilegion.acil.numaralar.api.model.main.MainPhones;
import com.mobilegion.acil.numaralar.api.model.main.MainPhonesRequest;
import com.mobilegion.acil.numaralar.api.model.provinces.ProvincesRequest;
import com.mobilegion.acil.numaralar.helpers.Constants;
import com.mobilegion.acil.numaralar.helpers.core.BaseFragment;
import com.mobilegion.acil.numaralar.helpers.dialog.DefaultDialog;
import com.mobilegion.acil.numaralar.helpers.utilities.Utilities;
import com.mobilegion.acil.numaralar.scenes.settings.SettingsFragment;
...
public class HomeFragment extends BaseFragment implements ResponseInterface, myOnClick {
    ...
    @BindView(R.id.select_city) public RelativeLayout dialogCity;
    @BindView(R.id.select_district) public RelativeLayout dialogDistrict;
    @BindView(R.id.phones) public TextView phonesTitle;
    @BindView(R.id.city) public TextView city;
    @BindView(R.id.district) public TextView district;
