...
package com.mobilegion.acil.numaralar.scenes.settings;
...
public class SettingsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (Utilities.PackageInfo(getContext()) != null)
            githubLink.setText(getString(R.string.version) + " " + Utilities.PackageInfo(getContext()).versionName);
