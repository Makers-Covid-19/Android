...
package com.mobilegion.acil.numaralar.helpers.db.tinydb;
...
import com.mobilegion.acil.numaralar.api.model.provinces.ProvinceModel;
...
public class TinyDB {
     ...
     */
    public void putListHomePhone(MainPhones obj, String id) {
        checkForNullKey(Constants.PHONE_LIST_OBJECT + id);
        Gson gson = new Gson();
        putString(Constants.PHONE_LIST_OBJECT + id, gson.toJson(obj));
    }

    public MainPhones getListHomePhone(String id) {
